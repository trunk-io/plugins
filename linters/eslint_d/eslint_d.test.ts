...
const preCheck = (driver: TrunkLintDriver) => {
  ...
  try {
    ...
    driver.debug(`About to install eslint_d deps to ${driver.getSandbox()}`);
    ...
    console.warn("Error installing eslint_d deps");
    console.warn(err);
    throw err;
  }
};

// This set of testing is incomplete with regard to failure modes and unicode autofixes with eslint_d, but it serves as a sampling
